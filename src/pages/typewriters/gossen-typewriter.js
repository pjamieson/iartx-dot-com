...
const GossenTypewritersPage = ({ data }) => {
  ...
  const seo_description = "Images of vintage Gossen typewriters offered for sale on iArtX.com, with links to details about each typewriter."

  return (
    <Layout>
      <Seo title="Gossen Typewriters" description={seo_description} />
      <div className="container page-container">
        <h1>Typewriters - Gossen</h1>
