...
<section className="brand-story">
  <div className="historical-images">
    <div className="image-container">
      <img className="card" src={tippa1} alt="Gossen Tippa typewriter" />
    </div>
  ...
  <div className="historical-text">
    ...
    <p>The company P. Gossen & Co. K.-G was founded in 1919 by the then 46-year-old German engineer, Paul Gossen. The new firm set about manufacturing and selling electrical measuring instruments. An early product—called the <em>Millivoltmeter</em>—was the first device offered for measuring voltage in the millivolt range. The company was successful, and expanded through the 1920s and 1930s. However, from 1939 into 1945—during World War II—the company was required to switch to the production of electrical instruments needed by the German armed forces.</p>
    
    <p>Paul Gossen had passed away during the war—in June 1942—and the company was inherited by his widow and children. Paul's son Hans Gossen, and his son-in-law, Karl Klarner, became the chief executives. In August 1945, the U.S. Group Control Council, Germany (USGCC) allowed the company to resume manufacturing its pre-war product line. Plans to expand into the production of typewriters were accelerated—if not initiated—at that time as well.</p>

    <h3>1948 — Gossen Launches Their First Typewriter</h3>

    <p>The chief designer of Gossen's first typewriter, the <b>Gossen Tippa</b>, was Erwin Pfaffenberger who had joined the company in 1924 as a trainee draughtsman. Pfaffenberger apparently strived to improve upon the <em>Hermes Baby</em>, which had been on the market since 1935 and was the first widely-distributed <em>ultra-portable</em> typewriter. When the Gossen Tippa was introduced in 1948, it had a nearly-identical footprint to that of the Baby. It had a similar metal lid that also was secured at the back of the machine with two short metal studs, and it was 3/8 inch shorter than the Baby at 2 1/4 inches (or 2 7/16 inches with the lid attached). At 8 pounds 11 ounces, including the lid, the Tippa weighed a mere 2 ounces more than the Baby.</p>

    <p>I am a fan and user of both the Gossen Tippa and the Hermes Baby, although I slightly prefer the feel of my Tippa. However—for me—each has its own application: I take the Tippa or a Baby when roaming, but I employ a second generation <em>Hermes 3000</em> on my desktop at home. My Baby keyboards provide diacritics for writing in French, Spanish, or Portuguese that my Tippa lacks. That bumps a Baby up to my first choice when I want those diacritics while roaming. Your own mileage may vary.</p>
    ...
    <p>Writer and typewriter collector Robert Messenger notes subsequent typewriter manufacturer acqusitions and mergers involving the Tippa: <em>Grundig</em> took over the <em>Triumph</em> typewriter brand in 1957, and then in 1966, the <em>Grundig-owned Triumph</em> company took control of <em>Adler</em>. Finally, in 1969, <em>Litton Industries</em> took over <em>Triumph-Adler</em>.</p>

    <p>There are several 1957 and 1958 <b>Adler Tippa</b> and <b>Triumph Tippa</b> galleries in the Typewriter Database. These typewriters look exactly like the Gossen Tippa B, but have <em>Adler Tippa</em> or <em>Triumph Tippa</em> nameplates below their right ribbon covers rather than <em>Gossen Tippa</em> ones. They have metal lids, and one also has the leather breifcase.</p>
    ...
    <p className="source"><b>Wallapop Spain</b>. <em><a href="https://es.wallapop.com/item/vintage-maquina-de-escribir-con-funda-1950s-745491921" target="_blank" rel="noopener noreferrer">1953 Gossen Tippa #78337 with Spanish keyboard and leather briefcase</a>.</em> Retreived 06 Apr 2023. [I tried to purchase this beauty and work out shipping from Spain to California with the seller, but failed. He thought I was a scammer and blocked me! I hope this machine finds a good home.]</p>
