...
const HermesTypewritersPage = ({ data }) => {
  ...
  const seo_description = "Images of vintage Hermes typewriters offered for sale on iArtX.com, with links to details about each typewriter."
        ...
        { paintings.length > 0 && <>
          <section className="brand-story">
            ...
            <div className="historical-text">
              <h2>A Brief History of E. Paillard S.A. and their Hermes Typewriters</h2>
              ...
              <p className="source"><b>TypewriterDatabase[dot]com</b>. The <em>Hermes Typewriter Serial Numbers</em> page, and the photo-illustrated <em>...Typewriters by Year then Serial Numbers</em> pages for Hermes Baby, Hermes Baby Featherweight, Hermes Rocket, Hermes 2000, and Hermes 3000.</p>
