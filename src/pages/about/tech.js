      ...
      <div className="container page-container contact">
        ...
        <MDBCard>
          <MDBCardBody>
            ...
            <p>In the Spring of 2021, I did a complete re-write of iArtX.com, modeled in large part after the site I developed for my son, the artist Blake Jamieson, which launched in mid 2020 at https:blake.art. iArtX.com site is now a React/Gatsby site, developed with Javascript. Rather than a static site hosted on AWS S3, it is now a dynamic site, deployed through AWS Amplify, and fed up-to-the-minute inventory data from a custom Strapi CMS backend. It also newly supports PCI-compliant credit card payment processing and other eCommerce features. In addition to the art content, sections for the sale of books and sports trading cards have been added. This allows me to offer the three main types of collectables that I buy and sell on one web site, backed by one database, one CMS, and one cart/checkout component.</p>
